...
public class ControlPractice {
	...
	public void practice10() {
		...
		case 2 :System.out.print("숫자를 한 개 입력하세요 : ");
		int numb = sc.nextInt();
		if (numb > 0 && numb % 2 == 0) {
			System.out.println("짝수다.");
		} else if (numb < 0) {
		...
		case 4 :System.out.print("1~12 사이의 정수 입력 : ");
		int month=sc.nextInt();
		//1,2,12월이면 -> 겨울
		//3~5월이면 -> 봄
		//6~8월이면 -> 여름
		...
		case 6 :System.out.print("권한을 확인하고자 하는 회원 등급 : ");
		String rating = sc.next();
		if(rating.equals("관리자")) {
			System.out.print("회원관리, 게시글 관리 게시글 작성, 댓글 작성, 게시글 조회");
		}else if(rating.equals("회원")){
		...
		case 7 :System.out.print("키(m)를 입력해 주세요 : ");
		double m = sc.nextDouble();
		System.out.print("몸무게(kg)를 입력해 주세요 : ");
		double kg = sc.nextDouble();
		double bmi = kg/(m*m);
		...
		case 8 :System.out.print("피연산자1 입력 : ");
		int su11 = sc.nextInt();
		System.out.print("피연산자2 입력 : ");
		int su111 = sc.nextInt();
		System.out.print("연산자를 입력(+,-,*,/,%)");
		...
		case 9 :System.out.print("중간 고사 점수 : ");
		int score = sc.nextInt();
		System.out.print("기말 고사 점수 : ");
		int score1 = sc.nextInt();
		System.out.print("과제 점수 : ");
		...
		System.out.print("출석 회수 : ");
		int at = sc.nextInt();
		double average1 = (score*20.0)/100.0;
		double average11 = (score1*30.0)/100.0;
		double average2 = (tast*30.0)/100.0;
		double average3 = (at*20.0)/20.0;
		double total = average11+average11+average2+average3;
		
		System.out.println("=========결과=========");
		if(70<=total&&at>=14) {
			System.out.print("중간 고사 점수(20) : "+average11+"\n기말 고사 점수(30) : "+average11+
					"\n과제점수\t(30) : "+average2+"\n출석점수\t(20) : "+average3+"\n총점 : "+total+"\nPASS");
		}else if(70>total&&at>=14) {
			System.out.print("중간 고사 점수(20) : "+average11+"\n기말 고사 점수(30) : "+average11+
					"\n과제점수\t(30) : "+average2+"\n출석점수\t(20) : "+average3+"\n총점 : "+total+"\nFail [점수 미달]");
